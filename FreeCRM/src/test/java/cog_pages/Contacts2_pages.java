 ...
 * Date: 09 Jan 2021
 * Description: validate fields in create new contact
 * 				alphanumeric value in first and last name
 *  			blank first and last name for error message
 *  			toggle button,drop-down, public and private access and file upload
 *  			*/
package cog_pages;
...
public class Contacts2_pages extends TestBase_Cogmento {
	...
	public void click_new_contact() throws InterruptedException  //click on new
	{   
	...
	public void validate_new_contactspage() throws Exception  //validate new contact page
	{
	...
	public void firstlast(String str1, String str2) throws Exception  //enter first and last name
	{
		fn.sendKeys(str1);
		Thread.sleep(2000);
		ln.sendKeys(str2);
	...
	public void validate_save() throws Exception  //to save first and last name
	{   save.click();
	    Thread.sleep(2000);
		edit.click();
	    Thread.sleep(3000);
	...
	public void blank_first_last() throws Exception //validate blank text field
	{   
	...
	public void errormsg()  //displaying error message
	{
	...
	public void company_textbox()  //checking empty Company textbox
	{
		company.click();
	...
	public void msg_for_emptycompany() //displaying message for empty company textbox
	{
	...
	public void public_private_button() throws Exception  //click on private public access button
	{
		tog_button.click();
		Thread.sleep(5000);
	}
	
	public void chk_button_state() throws Exception  //checking the state of private and public access button
	{
	...
	public void category_dropdown() throws Exception //saving element of drop-down in list
	{
		category.click();
		Thread.sleep(2000);
	...
	public void display_category() throws Exception //displaying selected category from drop-down
	{
	...
	public void all_tog_button() throws Exception //checking toggle button
	...
	public void imageplaceholder() throws Exception  //clicking on image place holder
	{
	...
	public void uploadimage() throws Exception  //upload image from system
	{
